...
if __name__ == '__main__':
    ...
    # parser.add_argument("data_source", help="choose the data source to train initial encoder-decoder. defaul is content")
    ...
    print ' '
    print 'data source used for initial encoder decoder is: ', modality
    ...
    (X_train, y_train), (X_test, y_test), nout, vocab_size = get_saudinet_data(args, modality=modality)
    ...
    # Build the network
    (encoder, decoder), cost, opt = get_core_net(
            nout=nout,
    ...
    # Save models
    file_prefix = './saved_models/' + modality
